...
import io.github.toyota32k.utils.ProgressWorker.Companion.PROGRESS_CURRENT_BYTES
import io.github.toyota32k.utils.ProgressWorker.Companion.PROGRESS_TOTAL_LENGTH
                        ...
                        WorkInfo.State.RUNNING -> {
                            if(progress != null) {
                                workInfo.progress.apply {
                                    progress(
                                        getLong(PROGRESS_CURRENT_BYTES, 0L),
                                        getLong(PROGRESS_TOTAL_LENGTH, 0L)
                                    )
                                }
                            }
                        }
